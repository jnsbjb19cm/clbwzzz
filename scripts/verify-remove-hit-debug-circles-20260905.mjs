...
function withoutBlockComments(source) {
  // Documentation can describe the debug circles that were removed. The
  // regression must inspect executable source, not fail because a block comment
  // contains words such as "debug HIT circle".
