...
export const SKILL_EFFECTS = {
  ...
  518: { kind: 'invuln_all_allies', duration: 10, debuffImmune: true, label: '圣盾术：10秒无敌并免疫负面效果' },
  ...
  539: { kind: 'fatal_curse', dps: 4, duration: 10, vulnerability: 3, label: '全屏持续伤害4(中毒目标受非中毒伤害+3)' },
